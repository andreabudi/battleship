...
- Landscape reflows the chrome, not just the grids: the title and status share one line, the battle log sits beside the New game button below 600px of height, and during placement the controls become a column to the left of the boards. Screenshot both orientations, since a layout that merely does not overflow can still leave the boards unusably small.
